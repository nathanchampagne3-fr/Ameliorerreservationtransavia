              ...
              {printSection >= 3 && (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="font-bold text-[#222]" style={{ fontSize: 12 }}>MARC RICHARD BORDENET</p>
                  </div>
                  <div>
              ...
              {printSection >= 4 && (
                ...
                >
                  {[
                    ...
                    { label: 'SIÈGE', value: '12A', big: true },
              ...
              {printSection >= 5 && (
                ...
                >
                  ...
                  <p className="text-center mt-1.5" style={{ fontSize: 9, color: '#AAA', letterSpacing: '2px' }}>
                    TO3010 ORY RAK 15JUN25 12A ECO
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
      ...
      <div className="flex-1 overflow-y-auto" style={{ minHeight: 0 }}>
        ...
        <div className="bg-white px-5 py-4">
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 16 }}>
            ...
            <div>
              <p style={{ fontSize: 14, fontWeight: 600, color: '#222' }}>M. Nathan CHAMPAGNE</p>
        ...
        <div className="bg-white px-5 py-4">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <p style={{ fontSize: 13, color: '#222' }}>M. Nathan CHAMPAGNE</p>
            <p style={{ fontSize: 13, color: '#222' }}>nathanchampagne3@gmail.com</p>
            <p style={{ fontSize: 13, color: '#222' }}>+33651751748</p>
          </div>
        </div>
